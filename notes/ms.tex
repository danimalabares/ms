...
Now you just have to think what is divergence: divergence is \(\operatorname{div}X\overset{\operatorname{def}}{=}\operatorname{tr}(v \mapsto \nabla_vX)\). So
\begin{align*}
...
\item (This is the next exercise in \cite{doc}… *in progress*)
\end{enumerate}
\end{proof}
